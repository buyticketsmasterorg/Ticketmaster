...
```
    ...
    {/* --- CHAT VIEW: Shows when user selected, side-by-side on desktop --- */}
    <div className={`
        w-full md:w-2/3 
        h-full 
        flex flex-col 
    ...
    `}>
        ...
        {selectedUser ? (
            ...
            <div className={`flex-1 flex flex-col items-center justify-center ${darkMode ? 'bg-gray-900 text-gray-700' : 'bg-white text-gray-300'}`}>
