...
export default function SeatMap({ event, globalPrice, cart, setCart, onCheckout }) {
  ...
  const sections = [
    ...
    { id: '102', name: 'Sec 102', color: 'bg-indigo-600', border: 'border-indigo-400', price: globalPrice * 1.5 },
    { id: '103', name: 'Sec 103', color: 'bg-indigo-600', border: 'border-indigo-400', price: globalPrice * 1.5 },
    { id: '201', name: 'Sec 201', color: 'bg-blue-600', border: 'border-blue-400', price: globalPrice },
    { id: '202', name: 'Sec 202', color: 'bg-blue-600', border: 'border-blue-400', price: globalPrice },
        ...
        <div className="relative w-full max-w-lg mx-auto aspect-[4/3] bg-[#0f131a] rounded-[100px] border-4 border-white/10 shadow-2xl flex flex-col items-center justify-center overflow-hidden p-4">
           ...
           <div className="relative w-full h-full pt-20 flex flex-col items-center justify-center gap-4">
               ...
               <div className="w-full px-4 flex justify-between gap-1">
                  ...
                  <button onClick={() => { setView('section'); setSelectedSection(sections[6]); }} className="flex-1 h-16 bg-blue-900/40 border-2 border-blue-500/50 rounded-lg hover:bg-blue-600 transition-all flex items-center justify-center"><span className="text-[10px] font-bold text-blue-300">203</span></button>
               </div>
           </div>
        </div>
      )}
